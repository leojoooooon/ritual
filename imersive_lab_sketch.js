/*
  Project: Entropy Smear (Ultimate Smooth & Impact Edition)
...
// CONFIGURATION
const CHAOS_DURATION = 200;    // Time to max distortion
const CYCLE_DURATION = 20000; // Switch 
const TRANSITION_TIME = 3000; // Crossfade 
...
function setup() {
  ...
  fill(255);
  noStroke();
  text("CLICK TO FULLSCREEN", width/2, height/2);
}
